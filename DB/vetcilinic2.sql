...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 26 Eyl 2021, 11:26:14
...
(4, 888949, 25, 'Kap', 452132450, 'Su Kabı - Detay', 'Su Kabı', 248, 50, '1', '3', '1', 'Adet'),
...
--
ALTER TABLE `pay_in`
  MODIFY `pin_ıd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `sales`
  MODIFY `sa_ıd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- Tablo için AUTO_INCREMENT değeri `sales_payment`
--
ALTER TABLE `sales_payment`
  MODIFY `sa_pa_ıd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
